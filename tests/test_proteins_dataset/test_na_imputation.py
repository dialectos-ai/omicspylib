...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("global min", ['c1_rep1', 'c1_rep2', 'c2_rep4'], [15.046, 15.046, 15.046], 1.5, {'shift': 5, 'random_noise': True}),
        ...
        ("global row min", ['c1_rep1', 'c1_rep2', 'c2_rep4'], [15.22, 15.22, 15.22], 1.5, {'shift': 5, 'random_noise': True}),
        ...
        ("group row min", ['c1_rep1', 'c1_rep2', 'c2_rep4'], [15.95, 15.95, 15.22], 1.5, {'shift': 5, 'random_noise': True}),
        ...
        ("group row mean", ['c1_rep1', 'c1_rep2', 'c2_rep4'], [16.03, 16.03, 15.52], 1.5, {'shift': 5, 'random_noise': True}),
        ...
        ("group row median", ['c1_rep1', 'c1_rep2', 'c2_rep4'], [16.03, 16.03, 15.56], 1.5, {'shift': 5, 'random_noise': True}),
    ]
)
